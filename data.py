...
wiki_wiki = wikipediaapi.Wikipedia('ExiledRaptor', 'en')
...
p_wiki = wiki_wiki.page('Category:History')

get_categorymembers(p_wiki.categorymembers)

print('Page titles Fetch Complete')

stops = stopwords.words('english')

stops += ["a", "about", "above", "across", "after", "afterwards", "again", "against",
